    ...
    <div> <!-- Without an outer container div this component template will not render -->
        ...
        <transition name="fade">
            <div v-if="dataLoaded" v-cloak>
                <div class="inside_page_header" v-if="pageBanner" v-bind:style="{ background: 'linear-gradient(0deg, rgba(0,0,0,0.2), rgba(0,0,0,0.2)), #2c8181 url(' + pageBanner.image_url + ') center center' }">
                ...
                currentEvent : function (){
                    if(this.currentEvent != null) {
                        if (this.currentEvent.eventable_type === "Store"){
                            ...
                            if (_.includes(this.currentEvent.event_image_url_abs, 'missing')) {
                                this.currentEvent.image_url = "//codecloud.cdn.speedyrails.net/sites/5d7007246e6f641a97910000/image/png/1529532187000/eventsplaceholder2@2x.png";    
                            }
                        }
                    }
                }
