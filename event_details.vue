                    ...
                    <div  v-if="currentEvent">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <p class="event_details_dates">
                                    <span v-if="currentEvent.tags && currentEvent.tags.length >0">{{currentEvent.tags[0]}}</span>
                                </p>
                ...
                currentEvent : function (){
                    if(this.currentEvent != null) {
                        if (this.currentEvent.eventable_type === "Store"){
                            ...
                            if (_.includes(this.currentEvent.event_image_url_abs, 'missing')) {
                                this.currentEvent.image_url = "//codecloud.cdn.speedyrails.net/sites/5b2d4b7e6e6f647f1dfc0000/image/png/1529532187000/eventsplaceholder2@2x.png";    
                            }
                        }
                    }
                }
