                        ...
                        <div v-if="eventList" v-for="(events, key) in eventList" class="col-md-12" >
                            ...
                            <div class="row event_container" v-for="event in events">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <p class="event_dates"><span v-if="event.tags">{{event.tags[0]}}</span> | <span v-if="isMultiDay(event)">{{ event.start_date | moment("MMMM D", timezone)}} to {{ event.end_date | moment("MMMM D", timezone)}}</span><span v-else>{{ event.start_date | moment("MMMM D", timezone)}}</span></p>
                    ...
                    _.forEach(events, function (value, key) {
                        ...
                        if (today >= showOnWebDate) {
                            ...
                            if (value.store != null && value.store != undefined && _.includes(value.store.image_url, 'missing')) {
                                value.store.image_url = "//codecloud.cdn.speedyrails.net/sites/5b2d4b7e6e6f647f1dfc0000/image/png/1529532187000/eventsplaceholder2@2x.png";
                            }
                            
                            if (_.includes(value.image_url, 'missing')) {
                                value.image_url = "//codecloud.cdn.speedyrails.net/sites/5b2d4b7e6e6f647f1dfc0000/image/png/1529532187000/eventsplaceholder2@2x.png";
                            }
