                        ...
                        <div v-if="eventList" v-for="(events, key) in eventList" class="col-md-12" >
                            ...
                            <div class="row event_container" v-for="event in events">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <p class="event_dates"><span>{{event.tags[0]}}</span> | <span v-if="isMultiDay(event)">{{ event.start_date | moment("MMMM D", timezone)}} to {{ event.end_date | moment("MMMM D", timezone)}}</span><span v-else>{{ event.start_date | moment("MMMM D", timezone)}}</span></p>
