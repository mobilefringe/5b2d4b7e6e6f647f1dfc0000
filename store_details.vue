    ...
    <div> <!-- without an outer container div this component template will not render -->
        ...
        <transition name="fade">
            <div v-if="dataLoaded" v-cloak>
                <div class="inside_page_header" v-if="pageBanner" v-bind:style="{ background: 'linear-gradient(0deg, rgba(0,0,0,0.2), #2c8181 rgba(0,0,0,0.2)), url(' + pageBanner.image_url + ') center center' }">
            ...
            created (){
                this.loadData().then(response => {
                    ...
                    if(temp_repo != null) {
                        ...
                        this.pageBanner = {
                            "image_url": "//codecloud.cdn.speedyrails.net/sites/5d7007246e6f641a97910000/image/jpeg/1529532304000/insidebanner2.jpg"
                        }
                    }
            ...
            watch: {
                ...
                currentStore: function () {
                    if (_.includes(this.currentStore.store_front_url_abs, 'missing')) {
                        this.currentStore.store_front_url_abs = "//codecloud.cdn.speedyrails.net/sites/5d7007246e6f641a97910000/image/png/1529516445000/cerritos.png"
                    }
                    ...
                    _.forEach(this.currentStore.promotions, function(value, key) {
                        ...
                        if (_.includes(current_promo.image_url, 'missing')) {
                            current_promo.image_url = "//codecloud.cdn.speedyrails.net/sites/5d7007246e6f641a97910000/image/png/1529532181000/promoplaceholder2@2x.png";
                        }
                    ...
                    _.forEach(this.currentStore.events, function(value, key) {
                        ...
                        if (_.includes(current_event.image_url, 'missing')) {
                            current_event.image_url = "//codecloud.cdn.speedyrails.net/sites/5d7007246e6f641a97910000/image/png/1529532187000/eventsplaceholder2@2x.png";
                        }
