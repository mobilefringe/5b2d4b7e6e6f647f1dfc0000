            ...
            watch: {
                ...
                currentStore: function () {
                    if (_.includes(this.currentStore.store_front_url_abs, 'missing')) {
                        this.currentStore.store_front_url_abs = "//codecloud.cdn.speedyrails.net/sites/5b2d4b7e6e6f647f1dfc0000/image/png/1529516445000/cerritos.png"
                    }
                    ...
                    _.forEach(this.currentStore.promotions, function(value, key) {
                        ...
                        if (_.includes(current_promo.image_url, 'missing')) {
                            current_promo.image_url = "//codecloud.cdn.speedyrails.net/sites/5b2d4b7e6e6f647f1dfc0000/image/png/1529532181000/promoplaceholder2@2x.png";
                        }
                    ...
                    _.forEach(this.currentStore.events, function(value, key) {
                        ...
                        if (_.includes(current_event.image_url, 'missing')) {
                            current_event.image_url = "//codecloud.cdn.speedyrails.net/sites/5b2d4b7e6e6f647f1dfc0000/image/png/1529532187000/eventsplaceholder2@2x.png";
                        }
